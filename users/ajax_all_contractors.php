<?php       
 ...
 $user_id = $_SESSION["id"];
      ...
      if ($alpha == '') {
      $result_set = $db->get_contractors_rus_users("contractors", "contractorsType", $contr_or_carr, "isDeleted", 0, "name", $user_id); 
      } else {
      $result_set = $db->get_contractors("contractors", "contractorsType", $contr_or_carr, "isDeleted", 0, $alpha, "name", $user_id); 
      }
