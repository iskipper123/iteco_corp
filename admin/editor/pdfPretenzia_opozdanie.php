<?php
	session_start();
	require_once $_SERVER['DOCUMENT_ROOT'] . "/lib/checkWasUserLoginedAndIsAdmin.php";
	...
	if(isset($_GET["edit"])) {
        ...
        require_once $_SERVER['DOCUMENT_ROOT'] . '/partsOfPages/pdfTemplates/invoice/pretenzia_opozdanie.php'; 
