...
return array(
    'arial' =>
    array(
        'normal' => $distFontDir . 'ArialMT',
        'bold' => $distFontDir . 'Arial-BoldMT',
        'italic' => $distFontDir . 'Arial-ItalicMT',
        'bold_italic' => $distFontDir . 'Arial-BoldItalicMT'
    ),
    'calibri' =>
    array(
        'normal' => $distFontDir . 'calibri',
        'bold' => $distFontDir . 'calibrib',
        'italic' => $distFontDir . 'calibrii',
        'bold_italic' => $distFontDir . 'calibriz'
    ),
    'sans-serif' =>
        array(
    ...
    'courier' =>
        array(
            'normal' => $distFontDir . 'cour',
            'bold' => $distFontDir . 'courbd',
            'italic' => $distFontDir . 'couri',
            'bold_italic' => $distFontDir . 'courbi'
        ),
    'helvetica' =>
        array(
            'normal' => $distFontDir . 'Helvetica',
