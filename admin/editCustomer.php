<?php
	...
	if(isset($_POST["edit"])) {
		...
		if(!$error) {
			...
			$db->editContractor($id, $name, $company_form, $contactName, $phone, $email, $country, $city, $bankDetails, $headName, $carsAmount, $directions, $comments, $isMarked, $idUser, $date, $cod_fiscal, $company_import_export, $company_season);
